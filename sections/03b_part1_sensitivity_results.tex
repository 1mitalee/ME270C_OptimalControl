...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.70\columnwidth]{sections/PART5C/control_energy_vs_scale.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.70\columnwidth]{sections/PART5C/delta_p_x_time_history_scale_1p0.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.70\columnwidth]{sections/PART5C/delta_p_z_time_history_scale_1p0.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.70\columnwidth]{sections/PART5C/delta_v_x_time_history_scale_1p0.png}
    \caption{Horizontal velocity perturbation \(\delta v_x(t)\) for perturbation scale \(\gamma=1\).}
    \label{fig:vx-scale1}
\end{figure}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.70\columnwidth]{sections/PART5C/delta_v_z_time_history_scale_1p0.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.70\columnwidth]{sections/PART5C/delta_theta_time_history_scale_1p0.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.70\columnwidth]{sections/PART5C/delta_omega_time_history_scale_1p0.png}
